...
const ProductAttributes: React.FC = () => {
  ...
  const productAttributes = customAttributes.filter(attr => attr.forType === 'product');
    ...
    <div>
      <Card className="mb-6">
        <div className="flex justify-between items-center mb-4">
          <div>
            <h3 className="text-lg font-semibold">Amazon Product Attributes</h3>
            <p className="text-gray-600 mt-1">Define additional attributes to track for your Amazon products.</p>
          </div>
          <Button 
      ...
      <div className="bg-blue-50 p-4 rounded mb-6 border border-blue-100">
        ...
        <ul className="text-sm list-disc pl-6 mt-2 space-y-1 text-blue-900">
          <li>Filter products in the dashboard</li>
          <li>Include additional columns in your reports</li>
          <li>Set up advanced profit calculations</li>
          <li>Create custom segments for analysis</li>
