...
try {
  ...
  fs.writeFileSync(path.join(__dirname, 'start-optimized.mjs'), scriptContent);
  console.log('✅ Created start-optimized.mjs script');
  console.log('   Run this with: node start-optimized.mjs');
};
...
setInterval(() => {
  ...
  fs.writeFileSync(path.join(__dirname, 'monitor-memory.mjs'), monitorScript);
  console.log('✅ Created monitor-memory.mjs script');
  console.log('   Run this alongside your server with: node monitor-memory.mjs');
};
...
reader.on('close', () => {
  ...
  fs.writeFileSync(path.join(__dirname, 'split-csv.mjs'), splitterScript);
  console.log('✅ Created split-csv.mjs script');
  console.log('   Use this to split large CSV files: node split-csv.mjs large-file.csv 5000');
};
...
console.log('3. For very large files, split them first: node split-csv.mjs your-large-file.csv 5000');
console.log('4. Start server with memory limits: node start-optimized.mjs');
